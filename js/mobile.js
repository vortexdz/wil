...
(function (window, $) {
    ...
    SG.Initer = {
        ...
        initToolsActions: function () {
            ...
            $("#share_fb").on(END_EV, function (e) {
                ...
                var subj = _lang['sura_s'] + ' ' + QuranData.Sura[sura][sura_key] + ' : ' + _lang['aya_s'] + ' ' + aya;
                var aya_id = aya2id(sura, aya);
                var url = 'http://facebook.com/sharer/sharer.php?u=' + encodeURIComponent('http://quran.ksu.edu.sa/index.php?aya=' + sura + '_' + aya + '&l=' + currLang + '#aya=' + sura + '_' + aya);//+'&p[title]='+escape(subj)+'&p[summary]='+escape(nass)+'&p[images][0]='+escape('http://quran.ksu.edu.sa/images_home/quran_img_th.png');
                SG.Plugins.Tools.openurl(url, this);
        ...
        postInit: function () {
            ...
            $("#trans_sel_trans").on("tapone", function(e){
            		...
            		setTimeout(function(){
	                    ...
	                    {title:'Europe',cnt:['en_sahih','fr_hamidullah','es_navio','pt_elhayek','de_bubenheim','tr_diyanet','bs_korkut','sq_nahi','it_piccardo','nl_siregar']},
	                    {title:'Asia',cnt:['ur_jalandhry','ku_asan','pr_tagi','id_indonesian','ms_basmeih','th_thai','bn_bengali','ml_abdulhameed','ta_tamil','ru_kuliev','uz_sodik','zh_jian']},
    ...
    function getTrans(page, trans, cb) {
        ...
        var url = url_interface + "&do=tarjama&tafsir=" + trans;
        ...
        SG.Plugins.DBP.trans(trans, begin, end, function (j) {
            ...
            $.get(url + "&b_sura=" + b_sura + "&b_aya=" + b_aya + "&e_sura=" + e_sura + "&e_aya=" + e_aya + "&11", function (json) {
                var j = {};
    ...
    function showTafsir(buEle) {
        ...
        function galb(sura, aya) {
            ...
            SG.Plugins.DBP.tafsir(author, id, function (nass) {
                ...
                hp = url_interface + '&do=tafsir&author=' + author + '&sura=' + sura + '&aya=' + aya;
                $obj.data('xhr', $.get(hp));
    ...
    function switchLang(lang, setT) {
        ...
        def_trans = (currLang == 'ar') ? 'ar_muyassar' : 'en_sahih';
