...
CANCEL_EV = 'mouseup';
END_BOUND = '';
if (hasPointer || window.navigator.pointerEnabled) {
	START_EV = 'pointerdown',
	MOVE_EV = 'pointermove',
	END_EV = 'pointerup',
	CANCEL_EV = 'pointercancel';
}
else if (hasMSPointer || window.navigator.msPointerEnabled) {
	START_EV = 'MSPointerDown',
	MOVE_EV = 'MSPointerMove',
	END_EV = 'MSPointerUp',
	CANCEL_EV = 'MSPointerCancel';
}
else if(hasTouch){
	START_EV = 'touchstart',
	MOVE_EV = 'touchmove',
...
(function ($, window, undefined) {
    var state,
        ...
        touch = {
             ...
             */
            on: function () {
                $(document).on(START_EV, touchstart)
                    .on(MOVE_EV, touchmove)
                    .on(END_EV, touchend);
             ...
             */
            off: function () {
                $(document).off(START_EV, touchstart)
                    .off(MOVE_EV, touchmove)
                    .off(END_EV, touchend);
